export default function MaxLogoOriginal({ className = "" }) {
  return (
    <svg
      className={`logo max-logo-original ${className}`}
      viewBox="0 0 1000 1000"
      aria-hidden="true"
    >
      <defs>
        <linearGradient id="max-gradient-overlay">
          <stop offset="0" stopColor="#00f" />
          <stop offset="1" stopOpacity="0" />
          <stop offset="1" stopOpacity="0" />
        </linearGradient>

        <linearGradient id="max-gradient-base">
        ...
        <linearGradient
          id="max-gradient-background"
          x1="117.847"
          x2="1000"
          y1="760.536"
          y2="500"
          gradientUnits="userSpaceOnUse"
          href="#max-gradient-base"
        />

        <radialGradient
          id="max-gradient-radial"
          cx="-87.392"
          cy="1166.116"
          r="500"
          fx="-87.392"
      ...
      <rect
        ...
        height="1000"
        ry="249.681"
        fill="url(#max-gradient-background)"
      />
